...
4.contact me for more it's impossible for you to figure out all colleciton and document it's a little bit complex.
...
- User authencation
- Quiz category
- Realtime answer verification
- quiz score
## remaning to add
- quiz based on user score and category
- daily/weekly quiz contest
- expanding category and genre of quiz
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/niranjandahal/QuizApp.git
